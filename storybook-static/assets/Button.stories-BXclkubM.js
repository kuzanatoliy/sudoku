import{i as s,c as l,m as o,t as I}from"./web-CwM5U4Iq.js";import{B as r,E as n,a as t}from"./Button-BFHbf6yD.js";var T=I("<div>");const v={title:"Components/Button",component:r,tags:["autodocs"],argTypes:{children:{type:{name:"string",required:!1},control:{type:"text"},description:"The content of the component",table:{disable:!0,type:{summary:"string"}}},class:{type:{name:"string",required:!1},control:{type:"text"},description:"Additional css classes",table:{disable:!1,type:{summary:"string"}}},variant:{type:{name:"string",required:!1},control:{type:"select"},description:"The variant to use",table:{disable:!1,type:{summary:"string"},defaultValue:{summary:n.CONTAINED}},options:[n.CONTAINED,n.OUTLINED]},size:{type:{name:"string",required:!1},control:{type:"select"},description:"The size of the component",table:{disable:!1,type:{summary:"string"},defaultValue:{summary:t.MEDIUM}},options:[t.SMALL,t.MEDIUM,t.LARGE]},isDisabled:{type:{name:"boolean",required:!1},control:{type:"boolean"},description:"If true, the component is disabled",table:{disable:!1,type:{summary:"boolean"},defaultValue:{summary:"false"}}},isFullWidth:{type:{name:"boolean",required:!1},control:{type:"boolean"},description:"If true, the component take all available width",table:{disable:!1,type:{summary:"boolean"},defaultValue:{summary:"false"}}},onClick:{action:"onClick",type:{name:"function",required:!1},description:"Click event handler",table:{disable:!1,type:{summary:"function"},defaultValue:{summary:"() => {}"}}}},args:{children:"BUTTON TEXT",variant:n.CONTAINED,size:t.MEDIUM,class:"",isDisabled:!1,isFullWidth:!1}},i={argTypes:{children:{table:{disable:!1}}}},p={argTypes:{variant:{table:{disable:!0}}},render:a=>(()=>{var e=T();return e.style.setProperty("display","flex"),e.style.setProperty("gap","20px"),e.style.setProperty("flex-wrap","wrap"),s(e,l(r,o(a,{get variant(){return n.CONTAINED},children:"CONTAINED"})),null),s(e,l(r,o(a,{get variant(){return n.OUTLINED},children:"OUTLINED"})),null),e})()},u={argTypes:{size:{table:{disable:!0}}},render:a=>(()=>{var e=T();return e.style.setProperty("display","flex"),e.style.setProperty("gap","20px"),e.style.setProperty("align-items","flex-start"),e.style.setProperty("flex-wrap","wrap"),s(e,l(r,o(a,{get size(){return t.SMALL},children:"SMALL"})),null),s(e,l(r,o(a,{get size(){return t.MEDIUM},children:"MEDIUM"})),null),s(e,l(r,o(a,{get size(){return t.LARGE},children:"LARGE"})),null),e})()};var d,c,m;i.parameters={...i.parameters,docs:{...(d=i.parameters)==null?void 0:d.docs,source:{originalSource:`{
  argTypes: {
    children: {
      table: {
        disable: false
